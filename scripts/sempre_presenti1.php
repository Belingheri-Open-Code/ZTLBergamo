<?php
$url="https://www.dati.lombardia.it/resource/muag-42jz.json";/*$file=file_get_contents($url);*/$fileName="../dati/data.json";$myfile = fopen($fileName, "r") or die ("fallito");$file = fread($myfile, filesize($fileName));
