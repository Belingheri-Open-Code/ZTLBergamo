<?php
/**
 * Ritorna true o false se la zona colli è attiva al momento
 *
 * @param  dettagli  una stringa che contiene i dettagli di quando è attiva la ztl
 * @param  today array associativo che indica tutte le informazioni necessarie relative alla data attuale
 * @return bool se da visualizzare o meno
 */
function colli($dettagli,$today)
{
	...
	//foreach($dettagli as $item){echo $item;}
	return true;
}
/**
 * Ritorna true o false se la zona stadio o finardi è attiva al momento
 * Essa usa le api di football-data per confrontare gli orari.
 *
 * @param  today array associativo che indica tutte le informazioni necessarie relative alla data attuale
 * @param  tipo  un intero che mi fa capire se si tratta di finardi o di stadio
 * @return bool se da visualizzare o meno
 */
...
/**
 * Ritorna true o false se la zona è attiva al momento
 *
 * @param  pass la zona che sto esaminando al momento
 * @return bool se da visualizzare o meno
 */
...
/**
* Stampa tutto il javascript necessario per far funzionare la mappa
*/
